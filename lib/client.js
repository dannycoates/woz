...
Client.prototype.getScripts = function(callback) {
  this.request({ command: 'scripts' }, function(res) {
    callback(res.message, res.body);
  });
}

Client.prototype.setBreakpoint = function(sourceID, lineNumber, enabled, condition, callback) {
  var req = {
...
Client.prototype.continue = function(step, count, callback) {
  ...
  this.request(req, function(res) {
    callback(res.message, res.running);
  });
}
...
Client.prototype.v8flags = function(flags, callback) {
  ...
  this.request(req, function(res) {
    callback(res.message, res.success);
  });
}
